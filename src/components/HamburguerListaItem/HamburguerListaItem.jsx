...
function HamburguerListItem({
  ...
  const badgeCounter = (canRender, index) =>
    Boolean(canRender) && (
      <span className="HamburguerListaItem__badge">
        {' '}
        {quantidadeSelecionada}{' '}
      </span>
    );
  ...
  return (
    <div
      className="HamburguerListItem"
      onClick={(e) => clickItem(hamburguer._id)}
    >
      ...
      <div>
        ...
        <div className="HamburguerListItem__descricao">
          {' '}
      ...
      <img
        className="HamburguerListItem__foto"
        src={hamburguer.foto}
